...
export default function Powerplant() {
    const [activeTab, setActiveTab] = useState<string>('11');
    ...
    useEffect(() => {
        // Fetch categories
        axiosClient.get('/categoryByGroup/5')
    ...
    const fetchProjects = useCallback(() => {
        if (activeTab === 'project-list') {
            setLoading(true);
            axiosClient.get('http://tech.jayacm.co.id:8081/jayacm/jayacm/api/experienceListByGroup/5')
